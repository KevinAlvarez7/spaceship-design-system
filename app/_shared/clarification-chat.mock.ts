...
export const STEP_2_QUESTIONS: ClarificationQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'No new accounts — sign in with Singpass',
      'Must comply with MOE data and security requirements',
  ...
  },
  {
    ...
    options: [
      ...
      'Coverage — works for all schools in the cluster',
      'Others',
    ],
  },
];
