...
import { SpaceshipLogoScene, SpaceshipPlanet, SpaceshipStar } from '@spaceship/design-system';
import type { SceneDecoration } from '@spaceship/design-system';
...
const USAGE = `import { SpaceshipLogoScene } from '@spaceship/design-system';
import type { SceneDecoration } from '@spaceship/design-system';
...
export function AnimationsPage() {
  ...
  return (
    <div className="max-w-3xl space-y-10">
      ...
      <section className="space-y-10">
        <div>
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-semibold text-zinc-900">Spaceship Logo Scene</h2>
            <ExperimentBadge />
          </div>
          <p className="mt-2 text-sm text-zinc-500">
      ...
      {/* Asset grid — future Lottie/Rive/SVG assets */}
